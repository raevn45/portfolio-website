...
const nav = [['01','HOME','home'],['02','ABOUT','about'],['03','BUILD','build'],['04','OTHER TABS','tabs'],['05','NOW','now'],['06','TALK','talk']];
 ...
 return <div className="site">
  ...
  <main>
   <section id="home" data-section className="world world-home"><div className="sky-grid"/><div className="sun"/><div className="orbit orbit-a"/><div className="orbit orbit-b"/>
    <div className="home-copy"><p className="eyebrow">WELCOME TO MY SIDE OF THE INTERNET</p><h1>PRESHITA<br/><i>SHINDE</i></h1><div className="home-lines"><span>I BUILD THINGS.</span><span>I ASK QUESTIONS.</span><span>I FOLLOW RABBIT HOLES.</span></div></div>
   ...
   <section className="portal portal-paper" aria-hidden="true"><div className="window-card"><span>things-i-build://</span><b>— □ ×</b><div className="window-line"/></div><div className="tube"><span>THINGS</span><i>I BUILD.</i></div></section>
   <section id="build" data-section className="world world-build"><div className="section-meta"><span>03</span><b>BUILD / LIVE PROJECTS</b><span>OPEN ↗</span></div><div className="build-heading"><div><p className="eyebrow">MADE IT OUT OF MY HEAD.</p><h2>I BUILD<br/><i>THINGS.</i></h2></div><p>Two things that escaped the notebook and became real.</p></div><div className="projects">{projects.map(p=><a key={p.number} className={`project ${p.className}`} href={p.href} target="_blank" rel="noreferrer" onMouseEnter={()=>setCursorText('OPEN ↗')} onMouseLeave={()=>setCursorText('MOVE')}><div className="project-top"><span>{p.number} / {p.type}</span><b>↗</b></div><div className="project-body"><div><h3>{p.title}</h3><p>{p.text}</p><span className="visit">VISIT PROJECT ↗</span></div><div className="project-world"><span>{p.number}</span><i/></div></div></a>)}</div></section>
   <section className="portal portal-pink" aria-hidden="true"><div className="tube"><span>OTHER</span><i>TABS.</i></div><div className="marquee">MUN · TEDx · HORROR · FASHION · MAKEUP · PEOPLE · STORIES · DESIGN · AI · RESEARCH ·</div></section>
   <section id="tabs" data-section className="world world-tabs"><div className="section-meta"><span>04</span><b>OTHER TABS / RABBIT HOLES</b><span>HOVER THEM</span></div><div className="tabs-heading"><p className="eyebrow">MY BRAIN IS</p><h2>OPEN<br/><i>24 / 7.</i></h2><p>Not a list of skills.<br/>Just the things that keep pulling me back.</p></div><div className="interest-cloud">{interests.map((x,i)=><span key={x} style={{'--i':i}} onMouseEnter={()=>setCursorText(x)} onMouseLeave={()=>setCursorText('MOVE')}>{x}</span>)}</div><div className="tabs-bottom">MUN → TEDx → HEAD GIRL → RESEARCH → PEOPLE → STORIES →</div></section>
   ...
   <section id="now" data-section className="world world-now"><div className="section-meta"><span>05</span><b>NOW / LIVE SNAPSHOT</b><span>2026</span></div><div className="now-heading"><p className="eyebrow">CURRENTLY SOMEWHERE BETWEEN</p><h2>BUILDING<br/><i>AND</i><br/>FIGURING<br/>IT OUT.</h2></div><div className="now-grid"><div><small>BUILDING</small><strong>CANBOOK</strong><span>product / web</span></div><div><small>EXPLORING</small><strong>AI + HUMAN SYSTEMS</strong><span>research / questions</span></div><div><small>DOING</small><strong>MUN / TEDx / PEOPLE</strong><span>leading / listening</span></div><div><small>WATCHING</small><strong>HORROR MOVIES</strong><span>excellent decisions</span></div></div></section>
